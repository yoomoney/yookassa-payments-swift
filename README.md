...
| Параметр                   | Тип                  | Описание |
| -------------------------- | -------------------- | -------- |
| gatewayId                  | String               | По умолчанию `nil`. Идентификатор шлюза, выдается в Яндекс.Кассе. По умолчанию `nil`. Используется, если у вас несколько платежных шлюзов с разными идентификаторами. |
