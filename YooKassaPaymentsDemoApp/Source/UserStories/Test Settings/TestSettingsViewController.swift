...
protocol TestSettingsViewControllerDelegate: AnyObject {
...
extension TestSettingsViewController {
    ...
    private var processOptionsSection: SectionDescriptor {
        ...
        rows.append(CellDescriptor(configuration: { [unowned self] (cell: ContainerTableViewCell<TextValueView>) in
        ...
        if let processConfirmation = settings.processConfirmation {
            rows.append(CellDescriptor(configuration: { [unowned self] (cell: ContainerTableViewCell<TextFieldView>) in
